...
import { ArrowLeft, Calendar, Tag, User, FileText, Image as ImageIcon } from 'lucide-react';

const AgroguideDetailComponent = () => {
  // Sample data - replace with your actual data props
  const data = {
    title: "Kenali Jenis Tanahmu!",
    description: "Tips mengidentifikasi jenis tanah dan cara memperbaiki struktur tanah agar tanaman tumbuh subur.",
    content: "Tanah merupakan media tumbuh yang sangat penting bagi tanaman. Setiap jenis tanah memiliki karakteristik yang berbeda-beda. Untuk mendapatkan hasil panen yang optimal, penting bagi petani untuk mengenali jenis tanah di lahan mereka.\n\nBeberapa jenis tanah yang umum ditemukan antara lain:\n1. Tanah liat - memiliki kemampuan menahan air yang baik\n2. Tanah pasir - drainase baik namun mudah kekeringan\n3. Tanah humus - kaya akan bahan organik\n\nDengan mengenali karakteristik tanah, petani dapat menentukan jenis tanaman yang cocok dan cara pengelolaan yang tepat.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      {/* Hero Section dengan Circular Image */}
            ...
            <div className="relative">
              <div className="w-80 h-80 rounded-full overflow-hidden border-8 border-white/20 shadow-2xl">
                <div className="w-full h-full bg-gradient-to-br from-green-200 to-emerald-300 flex items-center justify-center">
                  {/* Simulated image - replace with actual Image component */}
            ...
            <div className="flex-1 text-white">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
                  <Tag size={16} />
                  <span className="text-sm font-medium">{data.category?.name || "Umum"}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-emerald-500">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold text-gray-800">Tanggal Publikasi</h3>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-teal-500">
              ...
              <p className="text-gray-600">{data.category?.name || "Tidak ada kategori"}</p>
            </div>
          </div>
