...
const sampleTestimonials: Testimonial[] = [
  {
    ...
    name: "Karjo",
    occupation: "Petani",
    imageUrl: "/assets/images/karjo.png", // Replace with actual image path
  },
  {
    id: "2",
    rating: 5,
    ...
    imageUrl: "/assets/images/reza.png", // Replace with actual image path
  },
  {
    id: "3",
    rating: 4,
    ...
    name: "Jono",
    occupation: "Karyawan",
    imageUrl: "/assets/images/jono.png", // Replace with actual image path
  },
  {
    id: "4",
    rating: 5,
    ...
    name: "Suptrapto",
    occupation: "Petani",
    imageUrl: "/assets/images/suptrapto.png", // Replace with actual image path
  },
];
...
const renderStars = (rating: number) => {
  ...
  for (let i = 0; i < 5; i++) {
    if (i < rating) {
      // Filled star (adjust color as needed)
      stars.push(
        <svg
          key={i}
      ...
      // Empty star (adjust color as needed)
      stars.push(
        <svg
          key={i}
...
const TestimonialCard: React.FC<{ testimonial: Testimonial }> = ({
  ...
  <div className="bg-primary-400 text-white rounded-lg shadow-md p-6 flex flex-col h-full">
    ...
    <p className="text-white/80 text-base mb-6 flex-grow line-clamp-5">
      {" "}
      {/* Added flex-grow and line-clamp */}"{testimonial.quote}"
    </p>
